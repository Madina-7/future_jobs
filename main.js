...
var options = {
  ...
  body: "grant_type=client_credentials&client_id=PAR_workit_7baf0f55844af373a7f4928e0959957a5de15448e4914f495caaf3f67d32865a&client_secret=dca0e77b24c717d9d772042280090e7aecef5bf6128e2a8410d0ad42b0a2f8f5&scope=application_PAR_workit_7baf0f55844af373a7f4928e0959957a5de15448e4914f495caaf3f67d32865a",
  headers: {
...
rp(options)
  .then((res)=>{
    ...
    // put it insude the "then" function to exec after we get authorized (token)
    rp(option2)
      .then((res2)=>{
